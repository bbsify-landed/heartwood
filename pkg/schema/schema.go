// Package schema provides declarative endpoint definitions that drive the
// heartwood code generator (cmd/hwgen). Define request and response fields
// using the typed builder functions ([String], [Int], [Ref], etc.) and attach
// validation constraints with chainable methods like [Field.Required] and
// [Field.MinLength].
package schema
